...
- [x] doom/p_map.rs (1052 lines, 0 docs)
...
- [x] doom/i_cdmus.rs (55 lines, 0 docs)
...
- [x] doom/i_video.rs (375 lines, 0 docs)
- [x] doom/memio.rs (410 lines, 8 docs)
- [x] doom/sha1.rs (453 lines, 9 docs)
- [x] doom/statdump.rs (102 lines, 3 docs)
- [x] doom/w_checksum.rs (65 lines, 0 docs)
- [x] doom/w_file.rs (100 lines, 0 docs)
- [x] doom/w_main.rs (38 lines, 0 docs)
- [x] doom/w_wad.rs (552 lines, 0 docs)
...
- [x] doom/m_config.rs (686 lines, 0 docs)
- [x] doom/m_controls.rs (861 lines, 0 docs)
...
- [x] audio/mod.rs (80 lines, 0 docs)
- [x] audio/music.rs (491 lines, 0 docs)
- [x] audio/sfx.rs (266 lines, 0 docs)
- [x] bin/struct_sizes.rs (70 lines, 0 docs)
- [x] doom/c_ffi.rs (739 lines, 145 docs)
- [x] doom.rs (92 lines, 0 docs)
- [x] gpu.rs (403 lines, 47 docs)
- [x] headless.rs (33 lines, 0 docs)
- [x] lib.rs (24 lines, 0 docs)
- [x] main.rs (260 lines, 25 docs)
- [x] platform/keys.rs (95 lines, 6 docs)
- [x] platform/mod.rs (200 lines, 47 docs)
- [x] types.rs (16 lines, 0 docs)
- [x] types/doom_bool.rs (214 lines, 22 docs)

## Test Harness (`doom/c_tests/`)

- [x] doom/c_tests/am_map_c.rs (137 lines, 16 docs)
- [x] doom/c_tests/d_loop_c.rs (92 lines, 8 docs)
- [x] doom/c_tests/d_main_c.rs (183 lines, 20 docs)
- [x] doom/c_tests/f_finale_c.rs (158 lines, 14 docs)
- [x] doom/c_tests/g_game_c.rs (360 lines, 41 docs)
- [x] doom/c_tests/harness.rs (29 lines, 2 docs)
- [x] doom/c_tests/hu_stuff_c.rs (282 lines, 38 docs)
- [x] doom/c_tests/i_scale_c.rs (425 lines, 50 docs)
- [x] doom/c_tests/lookup_tables.rs (65 lines, 0 docs)
- [x] doom/c_tests/map_data_structs.rs (362 lines, 22 docs)
- [x] doom/c_tests/mod.rs (31 lines, 0 docs)
- [x] doom/c_tests/p_enemy_c.rs (180 lines, 23 docs)
- [x] doom/c_tests/p_inter_c.rs (178 lines, 18 docs)
- [x] doom/c_tests/p_map_c.rs (209 lines, 26 docs)
- [x] doom/c_tests/p_maputl_c.rs (898 lines, 0 docs)
- [x] doom/c_tests/p_mobj_c.rs (148 lines, 17 docs)
- [x] doom/c_tests/p_pspr_c.rs (132 lines, 23 docs)
- [x] doom/c_tests/p_saveg_c.rs (99 lines, 11 docs)
- [x] doom/c_tests/p_spec_c.rs (183 lines, 23 docs)
- [x] doom/c_tests/p_switch_c.rs (102 lines, 9 docs)
- [x] doom/c_tests/r_data_c.rs (73 lines, 7 docs)
- [x] doom/c_tests/r_draw_c.rs (238 lines, 1 doc)
- [x] doom/c_tests/r_segs_c.rs (226 lines, 14 docs)
- [x] doom/c_tests/r_things_c.rs (246 lines, 34 docs)
- [x] doom/c_tests/struct_layouts.rs (271 lines, 0 docs)
- [x] doom/c_tests/st_stuff_c.rs (191 lines, 26 docs)
- [x] doom/c_tests/wi_stuff_c.rs (138 lines, 17 docs)
- [x] doom/c_tests/wrapping_arithmetic.rs (205 lines, 0 docs)
