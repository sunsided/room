...
This project is indexed by GitNexus as **room** (72281 symbols, 88323 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
