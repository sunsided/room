...
This project is indexed by GitNexus as **room** (72911 symbols, 88714 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
