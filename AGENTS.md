...
This project is indexed by GitNexus as **room** (73088 symbols, 89158 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
